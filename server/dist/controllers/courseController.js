...
exports.getCourse = exports.listCourse = void 0;
...
const listCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.json({ message: "Message retrieved successfully", data: courses });
    }
    catch (error) {
...
const getCourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.json({ message: "Message retrieved successfully", data: course });
    }
    catch (error) {
        res.status(500).json({ message: "Error retrieving courses", error });
    }
